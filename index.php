<html>
 ...
 <title>Doctors Information!</title>
  ...
  <img src="images/main_banner.jpg" HEIGHT=600 WIDTH=1000 alt="main_banner"/>
...
if (mysql_num_rows($result) > 0) {
    ...
    while ($row = mysql_fetch_array($result)) {
        ...
        $odd = !$odd; 
        echo '<td style="width:5%;"> <a href="doctor_profile.php?id=' . $row['dr_id'] .
            '">' . $row['dr_id'] . '</a></td>';
		echo '<td style="text-align: center; width:100px;"><a href="' .
        'doctor_profile.php?id=' . $row['dr_id'] .
